...
Output: {{"retrieval_query": "joystick", "brand": "Nintendo", "category": "joystick", "min_price": null, "max_price": 50, "min_rating": 4.0, "attributes": [], "semantic_constraints": []}}

Input: "under $60"
Output: {{"retrieval_query": "", "brand": null, "category": null, "min_price": null, "max_price": 60, "min_rating": null, "attributes": [], "semantic_constraints": []}}

Input: "what about cheaper ones"
Output: {{"retrieval_query": "", "brand": null, "category": null, "min_price": null, "max_price": null, "min_rating": null, "attributes": [], "semantic_constraints": []}}
        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system", 
                        "content": "You extract structured ecommerce search parameters. Return ONLY valid JSON."
                    },
                    {
                        "role": "user", 
                        "content": prompt
            ...
            logger.info(f"LLM parsing failed: {e}")
            return {
